...
sealed class KJCResult

final case class StringResult( string : String ) extends KJCResult {
  override def toString = string
}
final case class IntResult( int : Int ) extends KJCResult {
  override def toString = int.toString
}
final case class DoubleResult( double : Double) extends KJCResult {
  override def toString = double.toString
}

package object types {
  type Row = List[KJCResult] 
}
...
class ResultSetIterator( r : ResultSet ) extends Iterator[Row]
{
	...
	private def getResult(ic : Int) : KJCResult = {
